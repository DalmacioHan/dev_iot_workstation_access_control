                            ...
                            <td class="px-6 py-5 sm:px-8">
                                <div class="flex items-center justify-center gap-1">
                                    ...
                                    <button
                                        ...
                                        class="rounded-xl p-2.5 text-slate-400 transition hover:bg-violet-50 hover:text-violet-600 focus:outline-none focus:ring-4 focus:ring-violet-100"
                                        title="Remote Lock"
                                    >
                                        <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <button
                                        ...
                                        class="rounded-xl p-2.5 text-slate-400 transition hover:bg-sky-50 hover:text-sky-600 focus:outline-none focus:ring-4 focus:ring-sky-100"
